...
from main import (
    ...
    serpentine, compress_to_bw, run_length, dct_conversion, dwt_conversion
)
...
class TestTask5(unittest.TestCase):
    def test_compress2bw(self):
        ...
        compress_to_bw(input_image, output_image, quality)
...
class TestTask7(unittest.TestCase):
    def test_dct_idct(self):
        ...
        input_image = cv2.imread("/app/content/piplup.png", cv2.IMREAD_GRAYSCALE)

        # Perform DCT on the input image
        dct_matrix = dct_conversion.dct2(input_image)
...
class TestTask8(unittest.TestCase):
    def test_dwt_idwt(self):
        ...
        image_path = "/app/content/color.jpg"
